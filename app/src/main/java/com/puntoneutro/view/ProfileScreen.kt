...
import com.puntoneutro.viewmodel.ReadHistoryViewModel
import com.puntoneutro.viewmodel.BookmarkViewModel
import com.puntoneutro.viewmodel.AuthViewModel
...
fun EditProfileDialog(
    ...
    if (showDeleteConfirmation) {
        AlertDialog(
            ...
            text = {
                Text(
                    text = stringResource(R.string.Are_sure_you_want_to_delete),
                    color = secondaryTextColor
                )
            },
            confirmButton = {
                Button(
                    ...
                    Text(stringResource(R.string.Delete_account), color = Color.White)
                }
            },
            dismissButton = {
                TextButton(
