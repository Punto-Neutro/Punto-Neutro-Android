...
import com.puntoneutro.model.auth.BiometricAuthManager
    ...
    Box(
        ...
        Card(
            ...
            Column(
                    ...
                    onClick = {
                        ...
                        if (isLoginMode) {
                            ...
                            if (selectedCountry?.id == null) {
                                ...
                                errorMessage = context.getString(R.string.select_country_error) // Show an error

                            } else if (state.password.length < 6) {
                                errorMessage = context.getString(R.string.password_length_error)

                            }else {
                                succesMessage = context.getString(R.string.register_success_msg)
                                Log.d(TAG, "Selected country = ${selectedCountry?.id}")
                ...
                //  Fingerprint boton no implementado aún, funcionalidad futura
                if (isLoginMode && biometricManager.isBiometricAvailable() && !isLoginMode) {
