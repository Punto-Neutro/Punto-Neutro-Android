        ...
        floatingActionButton = {
            ...
            Box(
                ...
                FloatingActionButton(
                    ...
                    containerColor = if (isDarkMode) Color(0xFFFFFFFF) else Color(0xFF000000),
...
fun FeedbackDialog(isDarkMode: Boolean, categories: List<Category>, countries: List<Country>, viewModel: NewsFeedViewModel = viewModel(), onDismiss: () -> Unit) {
    ...
    val secondaryTextColor = if (isDarkMode) Color.Black else Color.White
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End) {
                    TextButton(onClick = {
                        ...
                        Text(stringResource(R.string.Clear_all), color = textColor)
                    }
...
fun ScopeChip(text: String, isSelected: Boolean, isDarkMode: Boolean, onClick: () -> Unit) {
    val selectedBgColor = if (isDarkMode) Color.White else Color.Black
    ...
    Surface(
        ...
        Box(contentAlignment = Alignment.Center, modifier = Modifier.padding(horizontal = 16.dp)) {
            Text(
                text = text,
                color = if (isSelected) secondaryTextColor else unselectedTextColor,
                fontSize = 14.sp,
...
fun CategoryChip(
    ...
    Surface(
        ...
        Text(
            ...
            color = if (selected) secondaryTextColor else unselectedTextColor,
            fontSize = 14.sp,
...
fun NewsCard(
    ...
    val textColor = if (isDarkMode) Color(0xFFE1E1E1) else Color(0xFF1A1A1A)
    val invtextColor = if (isDarkMode) Color(0xFF1A1A1A) else Color(0xFFE1E1E1)
    val secondaryTextColor = if (isDarkMode) Color(0xFFB0B0B0) else Color(0xFF666666)
...
fun BottomNavigationBar(
    ...
    val navigationItemColors = NavigationBarItemDefaults.colors(
        // This controls the "shade" or pill behind the icon
        indicatorColor = if (isDarkMode) Color.Black else Color.Transparent,

        // Optional: Control icon/label colors when selected
        selectedIconColor = if (isDarkMode) Color.White else Color.Black,
        selectedTextColor = if (isDarkMode) Color.White else Color.Black,

        // Optional: Control icon/label colors when NOT selected
    ...
    NavigationBar(
        ...
        NavigationBarItem(
            colors = navigationItemColors, // Apply colors here
